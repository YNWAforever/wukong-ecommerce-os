...
- Default format:runtime:check against main fails on the unchanged Task 3 report, docs/superpowers/plans/2026-09-05-source-binding-verification.md. Task 4 files are formatted; the unrelated report is preserved. The scoped runtime-format gate passed for all seven Task 4 files with RELEASE_BASE_SHA=07c26e238b5c4c0691548305b15905e0a7b0c564 after committing this slice.
